...
@ex.automain
def idl_train(mdp_num, gamma, alpha, beta1, beta2, sq_td_err_penalty,
    ...
    compute_batch_loss, idl_train, _ = create_tf_model(sess, mdp, q_scope, invsas_scope, invadt_scope,
